...
Pn=k*del_F*T0*kn ;%Суммарная мощность шумов приемника
...
grid on;
%РАсчет вероятностей по схеме ?? и ??Л?? для всех РЛС
